...
/*
    vector<CJob*>	GetJobList(void){return m_JobList;}
    vector<CWorkerThread*> GetIdleList(void){return m_IdleList;}
    vector<CWorkerThread*> GetBusyList(void){return m_BusyList;}
*/
    ...
    void    AppendToJobList(CJob* job);

    void    MoveToBusyList(CWorkerThread* idlethread);
    void    MoveToIdleList(CWorkerThread* busythread);

    void    WaitForAllWorkerToIdle(void);
