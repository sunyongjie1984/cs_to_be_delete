...
#ifndef __SPO_ALERT_SMB_H__
#define __SPO_ALERT_SMB_H__
...
void SpoAlertSmb(Packet *, char *, void *);
SpoAlertSmbData *ParseAlertSmbArgs(char *);
void SpoAlertSmbCleanExitFunc(int, void *);
void SpoAlertSmbRestartFunc(int, void *);

#endif  /* __SPO_ALERT_SMB_H__ */
