// testiocpDlg.cpp : implementation file
//
...
CTestiocpDlg::CTestiocpDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTestiocpDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CTestiocpDlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTestiocpDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CTestiocpDlg, CDialog)
	//{{AFX_MSG_MAP(CTestiocpDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
