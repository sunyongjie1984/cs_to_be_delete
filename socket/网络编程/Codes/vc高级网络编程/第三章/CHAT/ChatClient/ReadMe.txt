...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in ChatClient.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////

AppWizard creates one document type and one view:

ChatClientDoc.h, ChatClientDoc.cpp - the document
    These files contain your CChatClientDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CChatClientDoc::Serialize).

ChatClientView.h, ChatClientView.cpp - the view of the document
    These files contain your CChatClientView class.
    CChatClientView objects are used to view CChatClientDoc objects.
...
CntrItem.h, CntrItem.cpp - this class is used to
	...
	CChatClientView class and serialized as part of your CChatClientDoc class.
