...
//	MessageBox(m_servername);
	// TODO: Add your control notification handler code here
	NETRESOURCE lpNetResource1;
/*
	TCHAR lpPassword1[128];
	TCHAR lpUsername1[128];     */
      // user name
...
/*
		...
		strcpy(user_name, m_user_name.GetBuffer(0));*/
	...
	//lpNetResource1.lpRemoteName = "\\\\Gs";
	lpNetResource1.lpRemoteName = m_servername.GetBuffer(0);
	m_servernamemsg=m_servername;
	/*Ip153win-e1c741*/
	hr=WNetAddConnection2(&lpNetResource1,  // connection details
		                  m_password/*.GetBuffer(0)*/,           //password   LPCTSTR lpPassword,						   
		                  m_user_name,           // user name  LPCTSTR lpUsername,
	...
	{
/*		AfxMessageBox( "连接成功！" );*/
        CUsernameDlg dlg1(m_servername);
		dlg1.DoModal();
	}
	else
	{
