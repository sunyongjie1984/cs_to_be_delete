================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : CUser プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した CUser には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには CUser アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
CUser.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CCUserApp アプリケーション クラス
    の宣言をします。

CUser.cpp
    このファイルは CCUserApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\CUser.ico
    ...
    リソース ファイル CUser.rc によってインクルードされます。
...
CUserDlg.h, CUserDlg.cpp - the dialog
    Tこれらのファイルは CCUserDlg クラスを含みます。このクラスはアプリケーションの 
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) CUser.pch や既にコン 
