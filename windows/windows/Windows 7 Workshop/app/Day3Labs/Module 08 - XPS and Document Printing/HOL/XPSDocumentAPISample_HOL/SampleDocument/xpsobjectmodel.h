...
typedef /* [public][public][public][public][public][public][public][public][public][public][public][public][public][public][public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0016
    {
    FLOAT x;
    FLOAT y;
    } 	XPS_POINT;

typedef /* [public][public][public][public][public][public][public][public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0017
    {
    FLOAT width;
    FLOAT height;
    } 	XPS_SIZE;

typedef /* [public][public][public][public][public][public][public][public][public][public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0018
    {
    FLOAT x;
    FLOAT y;
    FLOAT width;
...
typedef /* [public][public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0019
    {
    FLOAT length;
    FLOAT gap;
    } 	XPS_DASH;

typedef /* [public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0020
    {
    LONG index;
    FLOAT advanceWidth;
...
typedef /* [public][public][public][public][public][public][public] */ struct __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0023
    {
    XPS_COLOR_TYPE colorType;
    /* [switch_type] */ union __MIDL___MIDL_itf_xpsobjectmodel_0000_0000_0027
        {
        struct 
            {
            UINT8 alpha;
...
#define IXpsOMPage_SetIsHyperlinkTarget(This,bIsHyperlinkTarget)	\
    ( (This)->lpVtbl -> SetIsHyperlinkTarget(This,bIsHyperlinkTarget) ) 
...
EXTERN_C const IID IID_IXpsOMObjectFactory;
    ...
    MIDL_INTERFACE("8921B39B-847F-41c1-A855-FE28CE8D5895")
...
#define IXpsOMObjectFactory_CreatePackageWriterOnFile(This,fileName,securityAttributes,flagsAndAttributes,optimizeMarkupSize,documentSequencePartName,coreProperties,packageThumbnail,documentSequencePrintTicket,discardControlPartName,packageWriter)	\
    ( (This)->lpVtbl -> CreatePackageWriterOnFile(This,fileName,securityAttributes,flagsAndAttributes,optimizeMarkupSize,documentSequencePartName,coreProperties,packageThumbnail,documentSequencePrintTicket,discardControlPartName,packageWriter) ) 

#define IXpsOMObjectFactory_CreatePackageWriterOnStream(This,outputStream,optimizeMarkupSize,documentSequencePartName,coreProperties,packageThumbnail,documentSequencePrintTicket,discardControlPartName,packageWriter)	\
    ( (This)->lpVtbl -> CreatePackageWriterOnStream(This,outputStream,optimizeMarkupSize,documentSequencePartName,coreProperties,packageThumbnail,documentSequencePrintTicket,discardControlPartName,packageWriter) ) 
...
#define XPS_E_INVALID_RESKEY                             MAKE_HRESULT(1, FACILITY_XPS, 0x2) 
...
#define XPS_E_INDEX_OUTOFRANGE                           MAKE_HRESULT(1, FACILITY_XPS, 0x5) 
#define XPS_E_VISUAL_CIRCULAR_REF                        MAKE_HRESULT(1, FACILITY_XPS, 0x6) 
#define XPS_E_THUMBNAIL_IMAGE_TYPE                       MAKE_HRESULT(1, FACILITY_XPS, 0x7) 
#define XPS_E_MUST_OBFUSCATE                             MAKE_HRESULT(1, FACILITY_XPS, 0x8) 
#define XPS_E_PACKAGE_DETACHED                           MAKE_HRESULT(1, FACILITY_XPS, 0x9) 
#define XPS_E_ALREADY_OWNED                              MAKE_HRESULT(1, FACILITY_XPS, 0xa) 
#define XPS_E_RESOURCE_NOT_OWNED                         MAKE_HRESULT(1, FACILITY_XPS, 0xb) 
#define XPS_E_NOT_NAMED                                  MAKE_HRESULT(1, FACILITY_XPS, 0xc) 
#define XPS_E_LOOKUP_NOT_FOUND                           MAKE_HRESULT(1, FACILITY_XPS, 0xd) 
#define XPS_E_LOOKUP_INVALID_TYPE                        MAKE_HRESULT(1, FACILITY_XPS, 0xe) 
#define XPS_E_STRING_TOO_LONG                            MAKE_HRESULT(1, FACILITY_XPS, 0xf) 
#define XPS_E_GLYPHS_MISSING                             MAKE_HRESULT(1, FACILITY_XPS, 0x10) 
#define XPS_E_TOO_MANY_INDICES                           MAKE_HRESULT(1, FACILITY_XPS, 0x11) 
#define XPS_E_MAPPING_OUTOFORDER                         MAKE_HRESULT(1, FACILITY_XPS, 0x12) 
#define XPS_E_MAPPING_OUTSIDE_STRING                     MAKE_HRESULT(1, FACILITY_XPS, 0x13) 
#define XPS_E_MAPPING_OUTSIDE_INDICES                    MAKE_HRESULT(1, FACILITY_XPS, 0x14) 
#define XPS_E_CARET_OUTSIDE_STRING                       MAKE_HRESULT(1, FACILITY_XPS, 0x15) 
#define XPS_E_CARET_OUTOFORDER                           MAKE_HRESULT(1, FACILITY_XPS, 0x16) 
#define XPS_E_ODD_BIDILEVEL                              MAKE_HRESULT(1, FACILITY_XPS, 0x17) 
#define XPS_E_MISSING_SEGMENT_DATA                       MAKE_HRESULT(1, FACILITY_XPS, 0x18) 
#define XPS_E_INVALID_FLOAT                              MAKE_HRESULT(1, FACILITY_XPS, 0x19) 
#define XPS_E_NEGATIVE_FLOAT                             MAKE_HRESULT(1, FACILITY_XPS, 0x1a) 
#define XPS_E_UNEXPECTED_COLORPROFILE                    MAKE_HRESULT(1, FACILITY_XPS, 0x1b) 
#define XPS_E_MISSING_COLORPROFILE                       MAKE_HRESULT(1, FACILITY_XPS, 0x1c) 
#define XPS_E_COLOR_COMPONENT_OUTOFRANGE                 MAKE_HRESULT(1, FACILITY_XPS, 0x1d) 
#define XPS_E_DUPLICATE_RESKEY                           MAKE_HRESULT(1, FACILITY_XPS, 0x1e) 
#define XPS_E_WRONG_CONTENT_TYPE_FOR_RELATIONSHIP_TARGET MAKE_HRESULT(1, FACILITY_XPS, 0x1f) 
#define XPS_E_REFERRED_PART_ABSENT_IN_PACKAGE            MAKE_HRESULT(1, FACILITY_XPS, 0x20) 
#define XPS_E_MISSING_RESOURCE_RELATIONSHIP              MAKE_HRESULT(1, FACILITY_XPS, 0x21) 
#define XPS_E_GLYPHS_WITHOUT_FONTURI                     MAKE_HRESULT(1, FACILITY_XPS, 0x22) 
#define XPS_E_DUPLICATE_RESOURCE                         MAKE_HRESULT(1, FACILITY_XPS, 0x23) 
#define XPS_E_MULTIPLE_DOC_SEQ_RELATIONSHIPS             MAKE_HRESULT(1, FACILITY_XPS, 0x24) 
#define XPS_E_DOCSEQ_RELATIONSHIP_ABSENT                 MAKE_HRESULT(1, FACILITY_XPS, 0x25) 
#define XPS_E_NO_IMAGE_FOR_IMAGEBRUSH                    MAKE_HRESULT(1, FACILITY_XPS, 0x26) 
#define XPS_E_MULTIPLE_THUMBNAILS_ON_PAGE                MAKE_HRESULT(1, FACILITY_XPS, 0x27) 
#define XPS_E_INVALID_THUMBNAIL                          MAKE_HRESULT(1, FACILITY_XPS, 0x28) 
#define XPS_E_INVALID_FONT_URI                           MAKE_HRESULT(1, FACILITY_XPS, 0x29) 
#define XPS_E_DOC_ABSENT_IN_PACKAGE                      MAKE_HRESULT(1, FACILITY_XPS, 0x2a) 
#define XPS_E_REFERRED_DOC_NOT_PRESENT                   MAKE_HRESULT(1, FACILITY_XPS, 0x2b) 
#define XPS_E_REFERRED_PAGE_NOT_PRESENT                  MAKE_HRESULT(1, FACILITY_XPS, 0x2c) 
#define XPS_E_PAGE_ABSENT_IN_DOC                         MAKE_HRESULT(1, FACILITY_XPS, 0x2d) 
#define XPS_E_NO_GUID_IN_OBF_FONT                        MAKE_HRESULT(1, FACILITY_XPS, 0x2e) 
#define XPS_E_MULTIPLE_PRINT_TICKETS_ON_PAGE             MAKE_HRESULT(1, FACILITY_XPS, 0x2f) 
#define XPS_E_MULTIPLE_PRINT_TICKETS_ON_DOCUMENT         MAKE_HRESULT(1, FACILITY_XPS, 0x30) 
#define XPS_E_MULTIPLE_PRINT_TICKETS_ON_DOC_SEQ          MAKE_HRESULT(1, FACILITY_XPS, 0x31) 
#define XPS_E_INVALID_CONTENT_BOX                        MAKE_HRESULT(1, FACILITY_XPS, 0x32) 
#define XPS_E_BOTH_PATHFIGURE_AND_ABBR_SYNTAX            MAKE_HRESULT(1, FACILITY_XPS, 0x33) 
#define XPS_E_BOTH_RESOURCE_AND_SOURCEATTR_PRESENT       MAKE_HRESULT(1, FACILITY_XPS, 0x34) 
#define XPS_E_ONE_TO_ONE_MAPPING_EXPECTED                MAKE_HRESULT(1, FACILITY_XPS, 0x35) 
#define XPS_E_BLEED_BOX_PAGE_DIMENSIONS_NOT_IN_SYNC      MAKE_HRESULT(1, FACILITY_XPS, 0x36) 
#define XPS_E_XKEY_ATTR_REQUIRED_FOR_ELEMENT_IN_RES_DICT MAKE_HRESULT(1, FACILITY_XPS, 0x37) 
#define XPS_E_XKEY_ATTR_PRESENT_OUTSIDE_RES_DICT         MAKE_HRESULT(1, FACILITY_XPS, 0x38) 
#define XPS_E_DICTIONARY_ITEM_NAMED                      MAKE_HRESULT(1, FACILITY_XPS, 0x39) 
#define XPS_E_NESTED_REMOTE_DICTIONARY                   MAKE_HRESULT(1, FACILITY_XPS, 0x3a) 
#define XPS_E_RESTRICTED_FONT_NOT_OBFUSCATED             MAKE_HRESULT(1, FACILITY_XPS, 0x3b) 
#define XPS_E_INVALID_MARKUP                             MAKE_HRESULT(1, FACILITY_XPS, 0x3c) 
#define XPS_E_TARGET_PART_REQUIRED                       MAKE_HRESULT(1, FACILITY_XPS, 0x3d) 
#define XPS_E_INVALID_XML_ENCODING                       MAKE_HRESULT(1, FACILITY_XPS, 0x3e) 
#define XPS_E_MULTIPLE_REFERENCES_TO_PART                MAKE_HRESULT(1, FACILITY_XPS, 0x3f) 
