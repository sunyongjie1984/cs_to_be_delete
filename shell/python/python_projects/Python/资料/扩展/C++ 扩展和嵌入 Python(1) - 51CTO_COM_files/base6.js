...
function getcommentend(tid){
 	var url = "/shtml/comment/artcomment3.php?artid="+tid;
...
function getArtCount(tid){
	...
	ajax.open("GET", url, false);
	ajax.send();
	document.getElementById('pinglun_1').innerHTML = ajax.responseText;
	document.getElementById('pinglun_2').innerHTML = ajax.responseText; 
