...
#if !defined(AFX_DEFAULTALLOCATOR_H__A9B87286_E1DE_414B_B1FD_C4D7C5835042__INCLUDED_)
#define AFX_DEFAULTALLOCATOR_H__A9B87286_E1DE_414B_B1FD_C4D7C5835042__INCLUDED_
...
public:
	...
	static char* chunk_alloc(size_t size, int &nobjs)
	{
		...
		else if ( bytes_left >= size )
		{
			...
			PostMessage(hwnd, WM_SETALLOC, static_cast<LPARAM>(4 + bytes_to_get), 0);


// 			static_cast<CTestAllocView*>(
// 				((CFrameWnd*)(AfxGetApp()->GetMainWnd()))->GetActiveView())->SetMalloc(bytes_to_get);
			//test
			if ( 0 == start_free )
			{
				int i;
...
#endif // !defined(AFX_DEFAULTALLOCATOR_H__A9B87286_E1DE_414B_B1FD_C4D7C5835042__INCLUDED_)
